...
GROUPS = {
    "Motion Works Inc": {"id": 181575178, "webhook": "https://discord.com/api/webhooks/1524376540610297926/oNWFWnYYeSA0fY5C8O_QvAKQPbJcfgRk5H4TcQSVVj9fbb0a3ng2aR5TPg7oCrbbQwwL"},
    "EroserisUGC":      {"id": 376787388, "webhook": "https://discord.com/api/webhooks/1524376550055612588/xOUUzDz-1WdeyHJs-l1P4KVL8G-1-tbrxExz_zhtbVBXOcLWakbJU9vaDflgOLOOEVfK"},
    "Ami Berloga":      {"id": 470988244, "webhook": "https://discord.com/api/webhooks/1524376555076190219/iTrQ_5pUSuBlvPP4m-ZYNzMopoDDI6AaJG4lJpEI-3p7kLaixwALBp5f2rt6Pnx0N9AN"},
}
...
def post_to_discord(webhook_url: str, group_name: str, sale: dict) -> None:
    embed = {
...
def main() -> None:
    ...
    for group_name, cfg in GROUPS.items():
        ...
        for txn in reversed(new_raw):
            ...
            post_to_discord(webhook, group_name, sale)
